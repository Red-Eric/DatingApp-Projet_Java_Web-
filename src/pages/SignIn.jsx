...
const SignIn = () => {
    ...
    */
    ...
    const GetInfo = () => {
        ...
        age_.toString().length == 2 ? validate = true : validate = false
        ...
        // TRUE 
        if (validate) {
            if (imgUrl === "http://localhost:5173/src/assets/default.jpg") {
                alert("Votre photo de profile")
            }
            else {
    ...
    return (
        <div>
            ...
            <div className="w-[40%] bg-gray-700 mt-6 ml-auto mr-auto rounded-3xl pb-3 max-h-[620px] overflow-y-scroll custom-scrollbar">
                <h1 className="font-medium text-center text-white text-4xl mb-8">Inscription</h1>
                <img id="pfp" onClick={changePfp} ref={pfpRef} className="cursor-crosshair w-32 h-32 rounded-full ml-auto mr-auto mb-2" src={pfp} alt="pfp" />
                ...
                <div className="ml-auto mr-auto w-[75%] mb-5">
                    ...
                    <textarea id="bio" maxLength={90} autoComplete="off" onChange={handleBio} rows="3" className="resize-none w-full shadow appearance-none border text-white rounded py-2 px-3  leading-tight focus:outline-none focus:shadow-outline" placeholder="Write your thoughts here..."></textarea>
                </div>
