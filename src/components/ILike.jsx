...
const IlikePage = () => {
    ...
    useEffect(() => {
        ...
        getUserFromId(parseInt(sessionStorage.getItem("id")))
            .then(data => setVisitorList(data.ilikes))
    }, [])
    ...
    return (
        <div className="mt-4 ml-5 mr-5">
            {
                visitorList.length > 0 && all.length > 0 ? showAll(visitorList, all) : <h1 className="font-medium text-2xl">Vous avez 0 Favori(s)</h1>
            }
        </div>
    )
}
